      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink href="https://twitter.com/greatAdams01" target="_blank" aria-label="Follow on X" icon={XIcon} />
            <SocialLink
              href="https://www.instagram.com/greatadams01?igsh=MXRjZnl1NTJqMXZpeg%3D%3D&utm_source=qr"
              target="_blank"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/greatAdams01"
              target="_blank"
            ...
            />
            <SocialLink
              href="https://whatsapp.com/channel/0029VbBTvR3A89Me6PL5vb0S"
              target="_blank"
